...
- Category food scenes must use authentic public Pantry d'Or catalogue photography. The homepage hero is the user-selected warm landscape sourdough image `premium-sourdough-hero.png`; crop it tightly enough to keep the bread prominent, hide any pricing, and avoid excessive empty desktop space.
...
- Do not use fictional storefront imagery or additional generated food photography. The user-selected hero is the sole exception; all supporting food, product, bakery, and brand photography must remain supplied or public Pantry d'Or imagery. Keep contact details verified against the source brief.
