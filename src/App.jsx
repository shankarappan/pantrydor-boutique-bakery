...
const categories = [
  { eyebrow: "Catering & events", title: "Made for the table", copy: "Platters, bundles and beautiful food for offices, celebrations and everything in between.", image: "/assets/catering.jpg", alt: "Pantry d'Or catering platter with bread, fruit, cheese and charcuterie", href: `${SHOP}/collections/catering-collection` },
  { eyebrow: "Pantry To Go", title: "Lunch, beautifully packed", copy: "Fresh lunches and everyday favourites, packed and ready when you are.", image: "/assets/lunches.jpg", alt: "Pantry d'Or packed lunch display", href: `${SHOP}/collections/pantry-packed-lunches` },
  { eyebrow: "Artisan breads", title: "The daily bake", copy: "Sourdoughs, croissants and seasonal bakes, handcrafted in small batches.", image: "/assets/artisan-breads.png", alt: "Fresh artisan sourdough loaves at Pantry d'Or", href: `${SHOP}/collections/artisanal-breads` },
];

const products = [
  { title: "Premium Corporate Package", price: "$343", copy: "A complete premium spread, ready for meetings and team gatherings.", image: "/assets/fruit-platter.jpg", alt: "Fresh seasonal fruit platter", href: `${SHOP}/products/premium-corporate-package` },
  { title: "Morning Tea Complete Bundle", price: "$239", copy: "Sweet, savoury and seasonal — everything a memorable morning tea needs.", image: "/assets/morning-tea.jpg", alt: "Assorted Pantry d'Or morning tea platter", href: `${SHOP}/products/morning-tea-complete-bundle` },
  { title: "Plain Sourdough", price: "$10", copy: "A crisp crust, open crumb and the quiet flavour of a true everyday loaf.", image: "/assets/plain-sourdough.jpg", alt: "Pantry d'Or plain sourdough loaf", href: `${SHOP}/products/sesame-barley-sourdough` },
];
  ...
  return (
    <div id="top" className="site-shell">
      ...
      <section className="hero">
        ...
        <div className="hero-image"><img src="/assets/pantry-platter.png" alt="A Pantry d'Or platter of artisan bread, fruit, cheese and cured meats" /></div>
